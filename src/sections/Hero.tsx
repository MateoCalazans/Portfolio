...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 mx-auto w-[600px] h-32 bg-[radial-gradient(ellipse_at_bottom,_var(--color-bg)_40%,_transparent_80%)] z-[5] pointer-events-none" />
